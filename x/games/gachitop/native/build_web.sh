...
em++ -std=c++20 -O2 \
  ...
  -s FILESYSTEM=0 \
  -s EXIT_RUNTIME=0 \
  -s EXPORTED_FUNCTIONS='["_gch_init","_gch_step","_gch_rgba_ptr","_gch_rgba_len","_gch_pop_sfx","_gch_music_enabled","_gch_save_json_ptr","_gch_save_json_len","_gch_reset","_gch_load_save_json","_gch_pointer_move","_gch_pointer_click","_malloc","_free"]' \
